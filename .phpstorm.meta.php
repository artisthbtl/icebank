...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Code\\icebank\\public\\storage','jwt.secret',
...
'boost.browser-logs','sanctum.csrf-cookie','users.index','users.store','users.show',
'users.update','users.destroy','accounts.index','accounts.store','accounts.show',
'accounts.update','accounts.destroy','companies.index','companies.store','companies.show',
'companies.update','companies.destroy','services.index','services.store','services.show',
'services.update','services.destroy','plans.index','plans.store','plans.show',
'plans.update','plans.destroy','transactions.index','transactions.store','transactions.show',
'transactions.update','transactions.destroy','subscriptions.index','subscriptions.store','subscriptions.show',
